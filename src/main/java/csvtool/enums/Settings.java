...
public enum Settings
{
    ...
    INCLUDE_KEY ("include-key", "--include-key",  true,  List.of("--ik", "-include-key", "-ik")),
    INCLUDE_KEY2("include-key2","--include-key2", true,  List.of("--ik2", "-include-key2", "-ik2")),
    INCLUDE_KEY3("include-key3","--include-key3", true,  List.of("--ik3", "-include-key3", "-ik3")),
    INCLUDE_VAL ("include-val", "--include-val",  true,  List.of("--iv", "-include-val", "-iv")),
    INCLUDE_VAL2("include-val2","--include-val2", true,  List.of("--iv2", "-include-val2", "-iv2")),
    INCLUDE_VAL3("include-val3","--include-val3", true,  List.of("--iv3", "-include-val3", "-iv3")),
