...
public class CSVRemapList
{
    ...
    public static final CSVRemapList EXAMPLES = new CSVRemapList(
        List.of(
                ...
                new CSVRemap(22, RemapType.IF_FIELDS_EQUAL, List.of("13", "14", "equal", "not equal")),
                new CSVRemap(23, RemapType.IF_RANGE, List.of("0", "15", "Less than 16", "16", "32", "Between 16 and 32", "Above 32")),
                ...
                new CSVRemap(25, RemapType.IF_NUMBER_EMPTY, List.of()),
                new CSVRemap(26, RemapType.IF_FLOAT_EMPTY, List.of()),
                new CSVRemap(27, RemapType.NOT_EMPTY, List.of("not_empty")),
                new CSVRemap(28, RemapType.NOT_EMPTY_FIELD, List.of("2", "not_empty")),
                new CSVRemap(29, RemapType.NOT_EMPTY_APPEND, List.of("3", "\n")),
                new CSVRemap(30, RemapType.NOT_EMPTY_COPY, List.of("3")),
                new CSVRemap(31, RemapType.NOT_EMPTY_MERGE, List.of("4")),
                new CSVRemap(32, RemapType.NOT_EMPTY_PREFIX, List.of("PREFIX: ")),
                new CSVRemap(33, RemapType.NOT_NUMBER_EMPTY, List.of()),
                new CSVRemap(34, RemapType.NOT_FLOAT_EMPTY, List.of()),
                new CSVRemap(35, RemapType.COPY, List.of("3")),
                new CSVRemap(36, RemapType.MERGE, List.of("3")),
                new CSVRemap(37, RemapType.APPEND, List.of("Extra")),
                new CSVRemap(38, RemapType.PREFIX, List.of("PREFIX: ")),
                new CSVRemap(39, RemapType.REPLACE, List.of("DEL", "")),
                new CSVRemap(40, RemapType.SANITIZE, List.of()),
                new CSVRemap(41, RemapType.PHONE_NUMBER, List.of("E164")),
                new CSVRemap(42, RemapType.SWAP, List.of("2"),
