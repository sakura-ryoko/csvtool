...
public class CSVRemapList
{
    ...
    public static final CSVRemapList EXAMPLES = new CSVRemapList(
        List.of(
                ...
                new CSVRemap(21, RemapType.IF_EQUAL_APPEND, List.of("13", "append")),
                new CSVRemap(22, RemapType.IF_EQUAL_PREFIX, List.of("13", "prefix", ":")),
                new CSVRemap(23, RemapType.IF_FIELDS_EQUAL, List.of("13", "14", "equal", "not equal")),
                new CSVRemap(24, RemapType.IF_RANGE, List.of("0", "15", "Less than 16", "16", "32", "Between 16 and 32", "Above 32")),
                new CSVRemap(25, RemapType.IF_DATE_RANGE, List.of("MM/dd/yyyy", "4", "MM/dd/yyyy", "5", "MM/dd/yyyy", "Before TimeDate", "During TimeDate", "After TimeDate", "Out of Range")),
                new CSVRemap(26, RemapType.IF_NUMBER_EMPTY, List.of()),
                new CSVRemap(27, RemapType.IF_FLOAT_EMPTY, List.of()),
                new CSVRemap(28, RemapType.NOT_EMPTY, List.of("not_empty")),
                new CSVRemap(29, RemapType.NOT_EMPTY_FIELD, List.of("2", "not_empty")),
                new CSVRemap(30, RemapType.NOT_EMPTY_APPEND, List.of("3", "\n")),
                new CSVRemap(31, RemapType.NOT_EMPTY_COPY, List.of("3")),
                new CSVRemap(32, RemapType.NOT_EMPTY_MERGE, List.of("4")),
                new CSVRemap(33, RemapType.NOT_EMPTY_PREFIX, List.of("PREFIX: ")),
                new CSVRemap(34, RemapType.NOT_NUMBER_EMPTY, List.of()),
                new CSVRemap(35, RemapType.NOT_FLOAT_EMPTY, List.of()),
                new CSVRemap(36, RemapType.COPY, List.of("3")),
                new CSVRemap(37, RemapType.MERGE, List.of("3")),
                new CSVRemap(38, RemapType.APPEND, List.of("Extra")),
                new CSVRemap(39, RemapType.PREFIX, List.of("PREFIX: ")),
                new CSVRemap(40, RemapType.REPLACE, List.of("DEL", "")),
                new CSVRemap(41, RemapType.SANITIZE, List.of()),
                new CSVRemap(42, RemapType.PHONE_NUMBER, List.of("E164")),
                new CSVRemap(43, RemapType.SWAP, List.of("2"),
