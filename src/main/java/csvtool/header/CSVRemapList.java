...
public class CSVRemapList
{
    ...
    public static final CSVRemapList EXAMPLES = new CSVRemapList(
        List.of(
                ...
                new CSVRemap(4, RemapType.DATE_NOW, List.of("yyyy-MM-dd")),
                new CSVRemap(5, RemapType.DATE_YEARS, List.of("yyyy-MM-dd")),
                new CSVRemap(6, RemapType.DATE_MONTHS, List.of("yyyy-MM-dd")),
                new CSVRemap(7, RemapType.DATE_DAYS, List.of("yyyy-MM-dd")),
                new CSVRemap(8, RemapType.INCLUDE, List.of("01", "02", "03")),
                new CSVRemap(9, RemapType.EXCLUDE, List.of("04", "05", "06")),
                new CSVRemap(10, RemapType.INCLUDE_REGEX, List.of("(?:^|\\W)included(?:$|\\W)")),
                new CSVRemap(11, RemapType.EXCLUDE_REGEX, List.of("(?:^|\\W)excluded(?:$|\\W)")),
                new CSVRemap(12, RemapType.PAD, List.of("3", "0")),
                new CSVRemap(13, RemapType.TRUNCATE, List.of("1")),
                new CSVRemap(14, RemapType.IF_STATIC, List.of("2", "apple", "orange")),
                new CSVRemap(15, RemapType.IF_EMPTY, List.of("was_empty")),
                new CSVRemap(16, RemapType.IF_RANGE, List.of("0", "15", "Less than 16", "16", "32", "Between 16 and 32", "Above 32")),
                new CSVRemap(17, RemapType.NOT_EMPTY, List.of("not_empty")),
                new CSVRemap(18, RemapType.COPY, List.of("3")),
                new CSVRemap(19, RemapType.MERGE, List.of("3")),
                new CSVRemap(20, RemapType.APPEND, List.of("Extra")),
                new CSVRemap(21, RemapType.SWAP, List.of("2"),
